...
namespace PlayerAgent
{
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        public AudioPlayer()
        {
            if (!_classInitialized)
            {
                ...
                try
                {
                    ...
                    currentPlPosition = (int)IsolatedStorageSettings.ApplicationSettings["index"];
                }
                catch (Exception ex)
                {
        ...
        protected override void OnPlayStateChanged(BackgroundAudioPlayer player, AudioTrack track, PlayState playState)
        {
            switch (playState)
            {
                ...
                case PlayState.Shutdown:
                    IsolatedStorageSettings.ApplicationSettings["index"] = currentPlPosition;
        ...
        protected override void OnUserAction(BackgroundAudioPlayer player, AudioTrack track, UserAction action, object param)
        {
            switch (action)
            {
                ...
                case UserAction.SkipPrevious:
                    ...
                    PlayState oldstate = player.PlayerState;
        ...
        public static int currentPlPosition = 0;
        ...
        private AudioTrack GetNextTrack()
        {
            ...
            {
                currentPlPosition = currentPlPosition % playlist.Count;
                if (playlist[currentPlPosition].onDisk)
                {
                    track = playlist[currentPlPosition].AudioTrack;
                    break;
                }
                else
                {
        ...
        private AudioTrack GetPreviousTrack()
        {
            ...
            for (int i = 0; i < playlist.Count; ++i)
            {
                if (currentPlPosition<0) currentPlPosition = playlist.Count-1;
                if (playlist[currentPlPosition].onDisk)
                {
                    track = playlist[currentPlPosition].AudioTrack;
                    break;
